...
int main()
{
	...
	cout << "Média das idades: " << (media = media / 10) << endl;
	
	for (int i = 0; i < 10; i++) {
		if (contatos[i].idade() < media) {
			cout << " Os contatos de idade menor que a media são: " << 
			endl << contatos[i].getNome();
		}
	}
